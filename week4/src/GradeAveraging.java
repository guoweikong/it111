...
public class GradeAveraging {
    ...
    public static void main(String[] args) {
        ...
        counter -= 1;  // subtract 1 counter, otherwise it counts 6 at the average
        ...
        System.out.println("You have earned the following letter grade of " + letterGrade
        + " and here is the message: " + message);
    }
}
